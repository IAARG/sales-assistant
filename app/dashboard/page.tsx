...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (!isAuthenticated) {
      ...
      setUserEmail(email || 'Administrador')
      setIsLoading(false)
    }
  }, [router])
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-sm text-yellow-700 bg-yellow-50 p-3 rounded-lg">🚩 Preço alto</li>
                <li className="text-sm text-yellow-700 bg-yellow-50 p-3 rounded-lg">🚩 Não tenho interesse</li>
                <li className="text-sm text-yellow-700 bg-yellow-50 p-3 rounded-lg">🚩 Preciso pensar</li>
              </ul>
            </div>
            <div>
              <h3 className="font-medium text-gray-800 mb-2">Sugestões de Ação</h3>
              <ul className="space-y-2">
                <li className="text-sm text-green-700 bg-green-50 p-3 rounded-lg">✅ Oferecer desconto progressivo</li>
                <li className="text-sm text-green-700 bg-green-50 p-3 rounded-lg">✅ Agendar follow-up em 48h</li>
                <li className="text-sm text-green-700 bg-green-50 p-3 rounded-lg">✅ Enviar casos de sucesso</li>
              </ul>
            </div>
          </div>
        </div>
